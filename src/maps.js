	...
	<>
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 959 593" preserveAspectRatio="true">
			...
			<g class="borders" fill="none">
				...
				<path class="or-wa" d="m161.5 91.9-30.3-7.3-2.8 1-5.4-.9-1.8-.9-1.5 1.2-3.3-.4-4.5.5-.9.7-4.2-.4-.8-1.6-1.2-.2-4.4 1.3-1.6-1.1-2.2.8-.2-1.8-2.3-1.2-1.5-.2-1-1.1-3 .3-1.2-.8h-1.2l-1.2.9-5.5.7-6.6-4.2 1.1-5.6-.4-4.1-3.2-3.7-3.7.1-.4-1.1.4-1.2-.7-.8-1 .1"/>
				<path class="pa-wv" d="m736.8 225.1 3.2 19.7 17.4-2.9"/>
				<path class="sd-wy" d="m351.4 187.6 3.9-43.9"/>
				<path class="tn-va" d="m697.7 321.1 28.9-3.3.2-1 4.6-.5-.3.7"/>
				<path class="ut-wy" d="m236.5 196-3.3 21.9 32.1 4.8"/>
				<path class="va-wv" d="m722.7 296.9.7.6-.8 1.2 1.5.7.1 1.5 4.4 2.3 2.3-.1 1.9-1.8.8-1.7 3 1.8 5.5-2.4.5-.9-.8-.5.6-1.4 1.5 1 4.3-3.1.7 1.1 2.3-2-.1-1.4 1.5-1.9-1.5-1.2 1-3.3 3.7-6.3-.4-1.9 2.1-2.2-.4-1.5 1.4-1.7.1-4.7 2.3.7 1.3 1.9 2.8.5 1.3-1.6 2.3-8.5 2.4 1.1 1-2.5.9-.8 1.4-1.8.9-.8.5-2.1 1.2-.8-.1-2.9.8-2.3-.9-1.6.2-.9 10 5.2.5-2.3.4-1.6.4-.7"/>
			</g>
			<circle class="state borders dccircle dc" cx="801.6" cy="252.1" r="5"/>
			<path class="separator1" fill="none" d="M215 493v55l36 45M0 425h147l68 68h85l54 54v46"/>
		</svg>
	</>
)};
